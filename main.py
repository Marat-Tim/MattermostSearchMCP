...
from tool import my_channels, search, channel_by_display_name, thread
...
mcp = FastMCP(
    ...
    Never give users the "id" field because they won't understand what it means. 
